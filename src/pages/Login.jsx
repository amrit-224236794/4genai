          ...
          <div>
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#" className="font-semibold text-[#0957D0] hover:text-[#11565f]">
                  Forgot password?
                </a>
              </div>
            </div>
            <div className="mt-2">
              <input
                ...
                required
                className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#0957D0] sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          <div>
            <button
              type="submit"
              className="flex w-full justify-center rounded-md bg-[#0957D0] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-[#0957D0] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0957D0]"
            >
              Sign in
            </button>
          </div>
